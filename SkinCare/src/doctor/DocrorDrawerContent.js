    ...
    <View style={{ flex: 1, backgroundColor: "#142a4b" }}>
      ...
      <View style={{flex:1,alignItems:'flex-start',justifyContent:'flex-start'}}>
        <TouchableOpacity
          ...
          onPress={() => navigateToScreen("Doctor")}
        >
        ...
        <TouchableOpacity
          style={styles.menuItem}
          onPress={() => navigateToScreen("DocProfile")}
        >
        ...
        <TouchableOpacity
          style={styles.menuItem}
          onPress={() => navigateToScreen("DoctorEditProfile")}
        >
          <FontAwesome6 name="user-doctor" size={24} color={Colors.white} />
...
export default DocrorDrawerContent;
